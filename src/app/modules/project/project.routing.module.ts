...
const routes: Routes = [
  ...
  { path: PROJECTS_EDIT_PATH.path, component: EditProjectPageComponent, data: { title: 'PROJECTS.TITLES.EDIT' } },
  { path: PROJECTS_ADD_PATH.path, component: AddProjectPageComponent, data: { title: 'PROJECTS.TITLES.ADD' } },
];
